...
### ZMIANA ### Główna funkcja przyjmuje teraz metodę analizy i zwraca wyniki na końcu
def analizuj_manifest(manifest_url: str, metoda_analizy: str, limit_stron: int = 5):
    print("\n" + "="*80)
    ...
    print(f"Znaleziono {len(canvases)} stron. Rozpoczynam analizę pierwszych {limit_stron}...")
    ...
    for i, canvas in enumerate(canvases[:limit_stron]):
        ...
        try:
            ...
            # Jeśli analiza wskazała, że to okładka, dodaj ją do listy wyników
    ...
    if not znalezione_okladki:
        ...
        # Sortuj wyniki od najwyższego prawdopodobieństwa
...
if __name__ == "__main__":
    ...
    analizuj_manifest(MANIFEST_DO_ANALIZY_1, metoda_analizy=wybrana_metoda, limit_stron=15)